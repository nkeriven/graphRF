...
% Single address.
% ---------------
\name{ \qquad Hashem Ghanem\qquad Nicolas Keriven \qquad Nicolas Tremblay\thanks{The authors warmly thank LightOn (\url{https://lighton.ai}) for the use of the OPU. HG is supported by the LabEx PERSYVAL (ANR-11-LABX-0025-01) \emph{``Bourse d'excellence''}. NT is partly supported by the French National Research Agency in the framework of the "Investissements d’avenir” program (ANR-15-IDEX-02) and the LabEx PERSYVAL (ANR-11-LABX-0025-01); as well as  the ANR GraVa (ANR-18-CE40-0005).} }
