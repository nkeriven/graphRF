...
# -*- coding: utf-8 -*-
"""
Created on Mon Apr 27 17:33:57 2020
...
nodes_num, features_num,samples_num, p_flyback, sigma= range (3,5),1000, 200, 0.85, 10 #################3########   
...
header="Adjacency Lighton random features with changing nodes_num and mult_factor variables:\n features_num, samples_num= 1000, 200\nnum_expe=1"
np.savetxt('SBM_Lighton_Adjacency_my_own.csv', np.array(result).flatten(), delimiter=',',header=header)
